...
import { hydratePreviewThumbnails } from "@/lib/hydrate";
...
export function TierListCard({ doc, onDuplicate, onDelete }: TierListCardProps) {
  const [thumbs, setThumbs] = useState<string[]>([]);

  useEffect(() => {
    let cancelled = false;
    hydratePreviewThumbnails(doc.items).then((urls) => {
